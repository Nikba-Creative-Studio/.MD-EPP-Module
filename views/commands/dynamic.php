    ...
    <div class="col-12">
        <div class="card border-info">
            <div class="card-header bg-info text-white">
                <h5 class="mb-0">
                    <i class="fas fa-cog me-2"></i>EPP Server Configuration
                </h5>
            </div>
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <p class="mb-0">
                            ...
                            <span id="currentServerUrl" class="text-muted">Not configured</span>
                        </p>
                        <small class="text-muted">
                            Configure your EPP server credentials to start using the sandbox
                        </small>
                    </div>
                    <div class="col-md-4 text-end">
                        <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#configModal">
                            <i class="fas fa-cog me-1"></i>Configure Server
                        </button>
                    </div>
                </div>
            </div>
